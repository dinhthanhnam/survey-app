                    ...
                    <div className="flex items-center space-x-2 w-full sm:w-auto">
                        ...
                        <div className="w-full sm:w-40 bg-gray-200 rounded-full h-2.5">
                            <div
                                ...
                                style={{
                                    width: `${((step + 1) / (totalSurveys + 1)) * 100}%`,
                                }}
                            ></div>
                        </div>
                    </div>
        ...
        <div className="max-w-5xl mx-auto bg-white shadow-lg rounded-lg p-8">
            {surveyData ? (
                <form onSubmit={(e) => e.preventDefault()}>
                    ...
                    <p className="text-gray-600 mb-6">{surveyData.survey_description}</p>
                                    ...
                                    {question.question_note && (
                                        <div className="relative ml-2">
                                            <FaQuestionCircle
                                                ...
                                                onMouseEnter={() => setTooltip(question.question_id)}
                                                onMouseLeave={() => setTooltip(null)}
                                            />
                                            {tooltip === question.question_id && (
                                        ...
                                        return (
                                            ...
                                            >
                                                <input
                                                    ...
                                                    checked={
                                                        isCheckbox
                                                            ? (answers[question.question_id] || []).includes(option.option_value)
                                                            : answers[question.question_id] === option.option_value
                                                    }
                                                    onChange={() =>
                                                        handleChange(
                                                ...
                                                >
                                                    {option.option_text}{" "}
                                                    {option.option_note && (
                                                        <i className="text-gray-400 text-sm">({option.option_note})</i>
                                                    )}
                                                </label>
                                            </div>
                                        );
