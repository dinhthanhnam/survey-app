                            ...
                            >
                                ...
                                {question.question_note && (
                                    <div
                                        ...
                                        onMouseEnter={() => setTooltipId(question.question_id)} // Chỉ mở tooltip cho đúng câu hỏi
                                        onMouseLeave={() => setTooltipId(null)} // Đóng tooltip khi rời chuột
                                    >
                                        <FaQuestionCircle className="text-teal-500 cursor-pointer" />
                                        {tooltipId === question.question_id && ( // Kiểm tra ID câu hỏi
