...
const pillarsData = [
    {name: 'Nhận thức của nhân viên & lãnh đạo về CĐS', weighted_percentage: 0.25, survey_id: 1 },
    {name: 'Chính sách và hỗ trợ đào tạo', weighted_percentage: 0.35, survey_id: 1},
    {name: 'Nhân sự phụ trách & tuyển dụng CNTT', weighted_percentage: 0.2, survey_id: 1 },
    {name: 'Mức độ triển khai và sẵn sàng của lãnh đạo', weighted_percentage: 0.15, survey_id: 1 },
    {name: 'Hỗ trợ từ NHNN & NHHTX đối với nhân sự QTDND', weighted_percentage: 0.05, survey_id: 1 },

    {name: 'Mức độ số hóa các quy trình nghiệp vụ chính', weighted_percentage: 0.25, survey_id: 2 },
    {name: 'Khả năng tích hợp công nghệ vào quản trị vận hành và dịch vụ khách hàng', weighted_percentage: 0.3, survey_id: 2},
    {name: 'Mức độ tự động hóa trong xử lý nghiệp vụ và vận hành nội bộ', weighted_percentage: 0.2, survey_id: 2 },
    {name: 'Mức độ tích hợp với hệ thống ngân hàng trung ương (NHNN) và ngân hàng hợp tác xã (NHHTX)', weighted_percentage: 0.15, survey_id: 2 },
    {name: 'Các rào cản và khó khăn trong quá trình chuẩn hóa và số hóa quy trình nghiệp vụ', weighted_percentage: 0.1, survey_id: 2 },

    {name: 'Hiện trạng hạ tầng CNTT', weighted_percentage: 0.3, survey_id: 3 },
    {name: 'Kế hoạch nâng cấp hạ tầng', weighted_percentage: 0.35, survey_id: 3 },
    {name: 'Ứng dụng công nghệ tiên tiến', weighted_percentage: 0.1, survey_id: 3 },
    {name: 'Mức độ tích hợp với hệ thống ngân hàng số', weighted_percentage: 0.25, survey_id: 3 },

    {name: 'Mức độ bảo mật dữ liệu KH & giao dịch', weighted_percentage: 0.3, survey_id: 4 },
    {name: 'Nhận thức & kỹ năng nhân sự', weighted_percentage: 0.2, survey_id: 4 },
    {name: 'Biện pháp ứng phó rủi ro', weighted_percentage: 0.25, survey_id: 4 },
    {name: 'Tuân thủ tiêu chuẩn NHNN', weighted_percentage: 0.15, survey_id: 4 },
    {name: 'Hỗ trợ từ tổ chức bên ngoài', weighted_percentage: 0.10, survey_id: 4 },
];

// Dữ liệu question
const questionsData = [
{
    question_text: 'Anh/Chị nhận thấy mức độ hiểu biết của anh chị về chuyển đổi số tại đơn vị mình như thế nào?',
...
{
    question_text: 'Anh/chị đã có những hành động cụ thể nào để thúc đẩy chuyển đổi số tại Quỹ?',
...
{
    question_text: 'Quỹ đã thực hiện/tham gia chương trình đào tạo nào về CNTT và chuyển đổi số?',
    ...
    question_options: [
        ...
        { option_text: 'Đã triển khai các chương trình khác', option_note: 'Ngoài các chương trình trên', require_reason: 1 },
    ],
},
{
...
},
{
    ...
    question_type: 'radiogroup',
    weighted_percentage: 0.1,
    belongs_to_pillar: 'Khả năng tích hợp công nghệ vào quản trị vận hành và dịch vụ khách hàng',
    survey_id: 2,
    question_target: ['Lãnh đạo & Quản lý'],
    question_options: [
        {
...
},
{
    ...
    question_type: 'radiogroup',
    weighted_percentage: 0.1,
    belongs_to_pillar: 'Mức độ tự động hóa trong xử lý nghiệp vụ và vận hành nội bộ',
    survey_id: 2,
    question_target: ['Cán bộ nghiệp vụ'],
    question_options: [
...
},
{
    ...
    question_note: 'Vui lòng chọn tối đa 3 lý do chính cản trở việc ứng dụng hiệu quả các HTTT tại đơn vịn',
    weighted_percentage: 0.03,
    belongs_to_pillar: 'Các rào cản và khó khăn trong quá trình chuẩn hóa và số hóa quy trình nghiệp vụ',
    survey_id: 2,
    question_type: 'checkbox',
...
},
{
    ...
    question_type: 'checkbox',
    weighted_percentage: 0.08,
    belongs_to_pillar: 'Mức độ tích hợp với hệ thống ngân hàng trung ương (NHNN) và ngân hàng hợp tác xã (NHHTX)',
    survey_id: 2,
    question_note: 'Có thể chọn nhiều đáp án',
    question_target: ['Cán bộ nghiệp vụ'],
    question_options: [
...
},
{
    ...
    question_options: [
        ...
        { option_text: 'Trang bị gần đầy đủ nhưng hạn chế trong sử dụng', weighted_value: 3 },
        { option_text: 'Trang bị đầy đủ và sử dụng hiệu quả', weighted_value: 4 },
        { option_text: 'Trang bị đầy đủ và sử dụng rất hiệu quả', weighted_value: 5 },
    ],
},
{
    question_text: 'Đơn vị của Anh/Chị đã được trang bị về hạ tầng CNTT theo hạng mục nào dưới đây?',
    ...
    question_options: [
        ...
        { option_text: 'Máy chủ riêng cho hệ thống cơ sở dữ liệu (Database Server)' },
        { option_text: 'Máy chủ dự phòng (Backup Server)' },
        { option_text: 'Hệ thống sao lưu dữ liệu (Backup Database System)' },
...
{
    question_text: 'Mức độ ổn định và tốc độ của mạng nội bộ và internet tại đơn vị là như thế nào?',
    ...
    question_target: ['Cán bộ nghiệp vụ'],
    question_options: [
        { option_text: 'Rất kém', option_note: 'thường xuyên mất kết nối', weighted_value: 0 },
        { option_text: 'Kém', option_note: 'mạng chậm, không ổn định', weighted_value: 1 },
        { option_text: 'Trung bình', option_note: 'đáp ứng nhu cầu cơ bản', weighted_value: 2 },
        { option_text: 'Tốt', option_note: 'ổn định, ít gián đoạn', weighted_value: 3 },
        { option_text: 'Rất tốt', option_note: 'tốc độ cao, ổn định liên tục', weighted_value: 4 },
    ],
},
{
    question_text: 'Đơn vị có kế hoạch nâng cấp cơ sở hạ tầng CNTT trong thời gian tới không?',
    ...
    question_options: [
        ...
        { option_text: 'Kế hoạch đầy đủ sẵn sàng triển khai', weighted_value: 4 },
    ],
},
{
    question_text: 'Quỹ đã có kế hoạch hoặc triển khai ứng dụng công nghệ điện toán đám mây vào hệ thống CNTT hiện tại ở mức độ nào?',
    ...
    question_options: [
        ...
        { option_text: 'Đã có kế hoạch nhưng chưa triển khai', weighted_value: 1 },
        { option_text: 'Đã triển chính thức một phần', weighted_value: 2 },
        { option_text: 'Đã triển khai hoàn chỉnh nhưng chưa khai thác hiệu quả', weighted_value: 3 },
        { option_text: 'Đã triển khai hoàn chỉnh và đang khai thác hiệu quả', weighted_value: 4 },
    ],
},
{
    question_text: 'Mức độ sử dụng các công nghệ AI hỗ trợ trong các quy trình tại đơn vị là như thế nào?',
    ...
    question_options: [
        ...
        { option_text: 'Sử dụng ở mức thử nghiệm một vài nghiệp vụ', weighted_value: 1 },
        { option_text: 'Đã sử dụng chính thức trong một vài nghiệp vụ đơn lẻ', weighted_value: 2 },
        { option_text: 'Đã sử dụng chính thức trong nghiệp vụ lõi', weighted_value: 3 },
...
},
{
    ...
    question_options: [
        ...
        { option_text: 'Đã triển khai Hệ thống Core nhưng hiệu quả thấp', weighted_value: 1 },
        { option_text: 'Đã triển khai Hệ thống Core đạt được hiệu quả như mong đợi', weighted_value: 2 },
        { option_text: 'Đã triển khai Hệ thống Core đạt được hiệu quả trên mong đợi', weighted_value: 3 },
        { option_text: 'Đã triển khai Hệ thống Core đạt được hiệu quả tối ưu', weighted_value: 4 },
    ],
},
{
    question_text:
...
},
{
    ...
    question_options: [
        ...
        { option_text: 'Tích hợp hoàn chỉnh nhưng sử dụng chưa hiệu quả', weighted_value: 3 },
        { option_text: 'Tích hợp hoàn chỉnh và sử dụng hiệu quả', weighted_value: 4 },
    ],
},
{
    question_text:
    ...
    question_options: [
        ...
        { option_text: 'Tích hợp hầu hết các quy trình', weighted_value: 3 },
        { option_text: 'Tích hợp đầy đủ', weighted_value: 4 },
    ],
},
{
    question_text: 'Mức độ sẵn sàng của nhân sự trong việc vận hành công nghệ mới như AI, điện toán đám mây tại đơn vị?',
    ...
    question_options: [
        { option_text: 'Hoàn toàn không sẵn sàng', weighted_value: 0 },
        { option_text: 'Không sẵn sàng', weighted_value: 1 },
        { option_text: 'Sẵn sàng nhưng cần đào tạo thêm', weighted_value: 2 },
        { option_text: 'Sẵn sàng và có thể ứng dụng ngay', weighted_value: 3 },
        { option_text: 'Hoàn toàn sẵn sàng và có thể hướng dẫn người khác', weighted_value: 4 },
    ],
},
{
    question_text:
...
{
    question_text: 'Hạ tầng CNTT tuân thủ tiêu chuẩn kỹ thuật ngành ngân hàng',
...
{
    question_text: 'Có phần mềm quản lý tập trung toàn bộ thiết bị CNTT trong đơn vị',
...
{
    question_text: 'Đơn vị có sử dụng các sản phẩm công nghệ dùng chung giữa QTDND, NHNN và NHHTX không?',
    question_name: 'Câu 3.14',
    question_type: 'radiogroup',
    question_target: ['Lãnh đạo & Quản lý'],
    question_options: [
        { option_text: 'Không sử dụng bất kỳ sản phẩm công nghệ nào dùng chung' },
        {
            option_text: 'Sử dụng một số sản phẩm công nghệ dùng chung ở mức cơ bản',
            option_note: 'Ví dụ: phần mềm thanh toán, báo cáo'
        },
        {
            option_text: 'Đã triển khai một số sản phẩm công nghệ dùng chung, nhưng còn phân tán và chưa đồng bộ'
        },
        {
            option_text: 'Đã triển khai và sử dụng đầy đủ các sản phẩm công nghệ dùng chung trong các nghiệp vụ cốt lõi',
            option_note: 'Ví dụ: hệ thống thanh toán, ngân hàng lõi'
        },
        {
            option_text: 'Đã hoàn thiện việc tích hợp và sử dụng các sản phẩm công nghệ dùng chung một cách toàn diện, đồng bộ và hiệu quả',
            option_note: 'Bao gồm tất cả các công cụ và dịch vụ từ NHNN, NHHTX'
        },
    ],
},
{
    question_text: 'Mức độ an toàn của hệ thống CNTT tại đơn vị trong việc bảo vệ dữ liệu khách hàng và giao dịch như thế nào?',
...
},
{
    ...
    question_options: [
        ...
        { option_text: 'Có chính sách nhưng chưa áp dụng', weighted_value: 1 },
        { option_text: 'Có chính sách nhưng tuân thủ chưa đầy đủ', weighted_value: 2 },
        { option_text: 'Chính sách bảo mật được tuân thủ tốt', weighted_value: 3 },
        { option_text: 'Chính sách bảo mật được tuân thủ rất tốt', weighted_value: 4 },
    ],
},
{
    question_text:
...
},
{
    ...
    question_options: [
        ...
        { option_text: 'Đã có kế hoạch nhưng chưa thực hiện đào tạo', weighted_value: 1 },
...
{
    question_text: 'Khi gặp sự cố an ninh mạng (rò rỉ dữ liệu, tấn công mạng, virus…), anh/chị có biết cách xử lý không?',
    ...
    survey_id: 4,
    question_options: [
        { option_text: 'Không biết cách xử lý và không biết cần báo cáo cho ai', weighted_value: 0 },
        { option_text: 'Biết cần báo cáo cho bộ phận IT nhưng không biết rõ quy trình', weighted_value: 1 },
        { option_text: 'Biết báo cáo và hiểu rõ quy trình xử lý sự cố', weighted_value: 2 },
        { option_text: 'Có thể thực hiện các biện pháp bảo vệ cơ bản trước khi báo IT', weighted_value: 3 },
        { option_text: 'Thành thạo xử lý sự cố và có thể hướng dẫn đồng nghiệp', weighted_value: 4 },
    ],
},
{
    question_text: 'Đơn vị đã có kế hoạch ứng phó rõ ràng khi xảy ra sự cố an ninh mạng chưa?',
    ...
    question_options: [
        ...
        { option_text: 'Kế hoạch đầy đủ nhưng chưa được thử nghiệm', weighted_value: 2 },
        { option_text: 'Kế hoạch đầy đủ và bắt đầu thử nghiệm', weighted_value: 3 },
...
},
{
    ...
    question_options: [
        ...
        { option_text: 'Cần thời gian dài để khắc phục', weighted_value: 1 },
        { option_text: 'Xử lý cơ bản nhưng cần hỗ trợ', weighted_value: 2 },
        { option_text: 'Xử lý nhanh & hiệu quả', weighted_value: 3 },
        { option_text: 'Xử lý rất tốt & có thể phòng ngừa sự cố', weighted_value: 4 },
    ],
},
{
    question_text:
...
},
{
    ...
    question_options: [
        ...
        { option_text: 'Trang bị cơ bản nhưng chưa sử dụng hiệu quả', weighted_value: 1 },
        { option_text: 'Đã trang bị đầy đủ', weighted_value: 2 },
        { option_text: 'Đã trang bị đầy đủ và sử dụng hiệu quả', weighted_value: 3 },
        { option_text: 'Đã trang bị và liên tục cải tiến', weighted_value: 4 },
    ],
},
{
    question_text:
...
},
{
    ...
    question_options: [
        ...
        { option_text: 'Tuân thủ và có kiểm tra định kỳ', weighted_value: 2 },
        { option_text: 'Hoàn toàn tuân thủ', weighted_value: 3 },
        { option_text: 'Hoàn toàn tuân thủ và liên tục cập nhật', weighted_value: 4 },
    ],
},
{
    question_text:
...
{
    question_text:
        'Có kế hoạch ứng phó sự cố an ninh mạng',
...
},
{
    ...
    question_options: [
        { option_text: 'Chưa có kế hoạch triển khai', weighted_value: 0 },
        { option_text: 'Đang trong quá trình triển khai, chưa hoàn thiện', weighted_value: 1 },
        { option_text: 'Đã triển khai một phần, nhưng chưa đồng bộ', weighted_value: 2 },
        { option_text: 'Đã triển khai hoàn chỉnh và đang hoạt động hiệu quả', weighted_value: 3 },
        { option_text: 'Đang tối ưu hóa và mở rộng hệ thống báo cáo tự động hóa', weighted_value: 4 },
    ],
},
// {
//     question_text:
...
async function main() {
    try {
        ...
        for (const question of questionsData) {
            const pillarId = await mapPillarNameToId(question.belongs_to_pillar);
            let parentId;
            if(question.parent) {
            ...
            if (question.question_options && question.question_options.length > 0) {
                ...
                console.log(`Created options for question: ${createdQuestion.question_name}`);
            }
